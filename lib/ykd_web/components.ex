defmodule YkdWeb.Components do
  ...
  attr :text, :string, default: "TRACK WHAT MATTERS /// OWN YOUR DATA /// SMART SET PROGRAMMING /// OFFLINE CAPABLE /// "
  ...
  def features(assigns) do
    assigns = assign(assigns, :features, [
      %{
        icon: "dumbbell",
  ...
  def power_features(assigns) do
    assigns = assign(assigns, :feature_cards, [
      %{
    ...
    <section class="py-24 bg-neutral-900 border-t border-neutral-800">
      <div class="container mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <%= for {card, idx} <- Enum.with_index(@feature_cards) do %>
  ...
  def privacy(assigns) do
    assigns = assign(assigns, :privacy_items, [
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div class="relative">
            ...
            <div class="relative bg-neutral-900/50 backdrop-blur-sm border border-neutral-800 p-8 md:p-12 rounded-2xl">
              <ul class="space-y-6">
                <%= for {item, idx} <- Enum.with_index(@privacy_items) do %>
  ...
  def ecosystem(assigns) do
    assigns = assign(assigns, :projects, [
      %{
  ...
  defp phone_carousel(assigns) do
    assigns = assign(assigns, :screenshots, [
      %{
