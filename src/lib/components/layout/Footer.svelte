<script lang="ts">
  import { Github, Twitter, Disc, Heart } from 'lucide-svelte';
</script>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
      ...
      <div>
        ...
        <ul class="space-y-3 font-mono text-sm text-neutral-400">
          <li><a href="https://github.com/pr0m3theuz/workout-app" class="hover:text-lime-400 transition-colors">Mobile App</a></li>
          <li><a href="https://github.com/pr0m3theuz/ykd_workout_app_server" class="hover:text-lime-400 transition-colors">Sync Server</a></li>
          <li><a href="https://github.com/pr0m3theuz/ykd_import_programs_kmp" class="hover:text-lime-400 transition-colors">Import Programs</a></li>
          <li><a href="https://github.com/pr0m3theuz/ykd_workout_program_pkl_generator" class="hover:text-lime-400 transition-colors">PKL Converter</a></li>
          <li><a href="https://github.com/pr0m3theuz/workout-app/releases" class="hover:text-lime-400 transition-colors">Releases</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-3 font-mono text-sm text-neutral-400">
          <li><a href="https://github.com/pr0m3theuz/workout-app" class="hover:text-lime-400 transition-colors">Documentation</a></li>
          <li><a href="https://github.com/pr0m3theuz/workout-app?tab=readme-ov-file#-contributing" class="hover:text-lime-400 transition-colors">Contributing</a></li>
          <li><a href="https://github.com/pr0m3theuz/workout-app/issues" class="hover:text-lime-400 transition-colors">Issues</a></li>
          <li><a href="https://github.com/pr0m3theuz/workout-app/discussions" class="hover:text-lime-400 transition-colors">Discussions</a></li>
          <li><a href="https://github.com/pr0m3theuz/workout-app/blob/ditto-sync/LICENSE" class="hover:text-lime-400 transition-colors">License</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <p class="text-xs text-neutral-600 font-mono flex items-center">
          Built with <Heart size={10} class="inline text-lime-400 mx-1" /> by pr0m3theuz
        </p>
      </div>
    </div>
