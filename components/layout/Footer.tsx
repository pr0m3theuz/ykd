        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              <svg className="opacity-80 hover:opacity-100 transition-opacity"  width="25%" height="25%" viewBox="0 0 3840 1540">
          ...
          <div>
            <h4 className="font-tech font-bold text-lg text-white mb-6 uppercase tracking-wider">Community</h4>
            <div className="flex gap-4 mb-6">
              <SocialIcon icon={<Github size={20} />} />
              <SocialIcon icon={<Twitter size={20} />} />
              <SocialIcon icon={<Disc size={20} />} />
            </div>
            <p className="text-xs text-neutral-600 font-mono">
              Built with <Heart size={10} className="inline text-lime-400 mx-1" /> by pr0m3theuz
            </p>
          </div>
        </div>
...
const SocialIcon: React.FC<{ icon: React.ReactNode }> = ({ icon }) => (
  <a href="#" className="w-10 h-10 rounded-full border border-neutral-700 flex items-center justify-center text-neutral-400 hover:text-black hover:bg-lime-400 hover:border-lime-400 transition-all duration-300">
    {icon}
  </a>
);
